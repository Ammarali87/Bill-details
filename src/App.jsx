...
function App() {
  ...
  const handleCustomerSelect = (customerId) => {
    setSelectedCustomer(data.customers[customerId -1].name)
    ...
    <div className="bg-indigo-700 text-white p-6 min-h-screen">
      ...
      <div className="flex flex-col bg-indigo-600 lg:flex-row justify-between">
        ...
        <div className=" mx-auto  ">
          ...
          <div className="grid h-[50vh] overflow-y-scroll bg-indigo-500 p-2 rounded rounded-md  mt-[-8px] grid-cols-4 gap-4">
      ...
      {/* Chart Section */}
         <div className="mt-9">
           <h2 className="text-3xl bg-indigo-500 rounded rounded-md  p-2 mt-11 mb-8">Click on user name above to show Graph</h2>
